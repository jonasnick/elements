...
Value claimwithdrawal(const Array& params, bool fHelp)
{
...
Value spendwithdrawal(const Array& params, bool fHelp)
{
    ...
    Array privkeyarr;
    privkeyarr.push_back(privkey.get_str());

    signParams.push_back(privkeyarr);
